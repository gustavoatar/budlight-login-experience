...
jQuery(document).ready(function($){
	...
	jQuery.get( 'locator-feature.html', function( data ) {
	...
	jQuery('.register').on('click', function(){
		...
		jQuery('footer').removeClass('hide').addClass('fadeIn');	
		...
		setTimeout( function() {  jQuery('.reward-ani').removeClass('fadeInUp').addClass('fadeOutUp'); }, 6000);
		setTimeout( function() { jQuery('.reward-sound')[0].play(); }, 1000);
	...
	jQuery('.guest-entry').on('click', function(){
		...
		jQuery('.reward-ani').addClass('hide')		
		jQuery('.age-gate').addClass('fadeOutUp').remove();
		jQuery('.entry').addClass('fadeOutUp').remove();
	...
	jQuery('.guests').on('click', function(){
		jQuery('.year-entry').focus();
		jQuery('.guests').toggleClass('grow');
		jQuery('.members').toggleClass('contract');
	});
